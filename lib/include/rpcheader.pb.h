...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_rpcheader_2eproto_metadata_getter(int index);
namespace mprpc {
class RpcHeader;
...
class RpcHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_rpcheader_2eproto_metadata_getter(kIndexInFileMessages);
  }
